...
class PropertyController extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->propertyDokan = PropertyDokan::class;
    ...
    public function showContact(Request $request)
    {
        ...
        if (count($rows) > 0) {
            foreach ($rows as $row) {
                $row->nameProperty = $this->property::where('id', $row->object_id)->first()->title ?? 'Property not found';
        ...
        switch ($action) {
            case "delete":
                foreach ($ids as $id) {
                    ...
                    $queryDokan = $this->propertyDokan::where("parent_id", $id);
                    if (!$this->hasPermission('property_manage_others')) {
                        $query->where("create_user", Auth::id());
