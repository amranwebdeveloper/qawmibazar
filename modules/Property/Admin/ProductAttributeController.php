...
parent::__construct();
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'product');
        ...
        return view('Property::admin.product.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'product')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Property'),
        ...
        return view('Property::admin.product.attribute.detail', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => route('property.admin.product.attribute.term.index',['id'=>$row->attr_id])
                ],
                [
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('product');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('product',$q);
