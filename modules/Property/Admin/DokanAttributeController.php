...
class DokanAttributeController extends AdminController
{
...
parent::__construct();
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'dokan');
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name'  => __('Dokan Attributes'),
                    'class' => 'active'
                ],
            ]
        ];
        return view('Property::admin.dokan.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'dokan')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Property'),
        ...
        return view('Property::admin.dokan.attribute.detail', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => route('property.admin.dokan.attribute.term.index',['id'=>$row->attr_id])
                ],
                [
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('dokan');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('dokan',$q);
