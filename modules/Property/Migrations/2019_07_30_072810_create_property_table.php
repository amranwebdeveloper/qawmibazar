...
class CreatePropertyTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bc_properties', function (Blueprint $table) {
            ...
            $table->integer('property_logo')->nullable();
        ...
        Schema::create('bc_property_dokans', function (Blueprint $table) {
            $table->bigIncrements('id');
            //Info
            $table->string('title', 255)->nullable();
        ...
        Schema::create('bc_property_dokan_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('origin_id')->unsigned();
            $table->string('locale')->index();
        ...
        Schema::create('bc_property_dokan_term', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('term_id')->nullable();
            $table->integer('target_id')->nullable();
            $table->bigInteger('create_user')->nullable();
        ...
        Schema::create('bc_property_dokan_dates', function (Blueprint $table) {
        ...
        Schema::create('bc_property_dokan_bookings', function (Blueprint $table) {

            $table->bigIncrements('id');
            $table->bigInteger('dokan_id')->nullable();
            $table->bigInteger('parent_id')->nullable();
