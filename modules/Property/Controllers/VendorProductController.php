...
class VendorProductController extends FrontendController
{
    ...
    protected function hasPropertyPermission($dokan_id = false)
    {
        ...
        $property = $this->propertyClass::find($dokan->parent_id);
    ...
    public function index(Request $request, $dokan_id)
    {
        ...
        return view('Property::frontend.manageProperty.product.index', $data);
    }

    public function create($dokan_id )
    {
        ...
        return view('Property::frontend.manageProperty.product.detail', $data);
    }
    ...
    public function edit(Request $request, $dokan_id, $id)
    {
        ...
        $dokan_created_user=$this->dokanClass::where('id',$dokan_id)->first();
        $translation = $row->translateOrOrigin($request->query('lang'));

        if (!$this->hasPermission('property_manage_others')) {
            if ($row->create_user != Auth::id() && $dokan_created_user->create_user != Auth::id()) {
    ...
    public function store(Request $request, $dokan_id, $id)
    {
        ...
        if ($id > 0) {
            ...
            if ($row->create_user != Auth::id()  && $dokan_created_user->create_user != Auth::id() and !$this->hasPermission('property_manage_others')) {
                return redirect(route('property.admin.product.index'));
            }
