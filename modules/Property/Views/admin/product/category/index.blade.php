        ...
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form
                            action="{{ route('property.admin.product.category.store', ['id' => $row->id ? $row->id : '-1', 'lang' => request()->query('lang')]) }}"
                            method="post">
                            @csrf
                            @include('Property::admin/product/category/form', ['parents' => $rows])
                            <div class="">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if (!empty($rows))
                            <form method="post" action="{{ url('admin/module/property/product-category/editBulk') }}"
                    ...
                    <div class="col-left">
                        <form method="get" action="{{ url('/admin/module/property/product-category') }} "
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="thumbnail d-none d-md-table-cell" style="width: 100px">
                                            {{ __('Thumbnail') }}</th>
                                        <th>{{ __('Name') }}</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="title">
                                                <a
                                                    href="{{ url('admin/module/property/product-category/edit/' . $row->id) }}">{{ $prefix . ' ' . $row->name }}</a>
                                            </td>
