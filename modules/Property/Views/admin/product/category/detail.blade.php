...
@section('content')
    <form action="{{route('property.admin.product.category.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
        @csrf
                    ...
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                @include('Property::admin/product/category/form')
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
