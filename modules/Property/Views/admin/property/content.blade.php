<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="{{ $translation->title }}" placeholder="{{ __('Name of the Business') }}"
                name="title" class="form-control">
        </div>
        <div class="form-group">
            <label>{{ __('Slug') }}</label>
            <input type="text" value="{{ $row->slug }}" placeholder="{{ __('Slug of the Business') }}" name="slug"
                class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                @if (is_default_lang())
                    <div class="form-group">
                        <label class="control-label">{{ __('Business Commity Image') }}</label>
                        <div class="form-group-image">
                            {!! \Modules\Media\Helpers\FileHelper::fieldUpload('commity_image_id', $row->commity_image_id) !!}
                        </div>
                    </div>
                @endif
            </div>
