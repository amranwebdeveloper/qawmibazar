...
?>
<div class="b-panel-title">{{__('Business information')}}</div>
<div class="b-table-wrap">
    <table class="b-table" cellspacing="0" cellpadding="0">
        ...
        @endif
        <tr>
            <td class="label">{{__('Business name')}}</td>
            <td class="val">
                ...
                <table class="pricing-list" width="100%">
                    ...
                    @if(!empty($dokans))
                        @foreach($dokans as $dokan)
                            <tr>
                                <td class="label">{{$dokan->dokan->title}} * {{$dokan->number}}
                                    :</td>
                                <td class="val no-r-padding">
                                    <strong>{{format_money($dokan->price * $dokan->number)}}</strong>
                                </td>
                            </tr>
                        @endforeach
                    @endif
