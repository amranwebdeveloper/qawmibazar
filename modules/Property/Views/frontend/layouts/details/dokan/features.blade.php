@php
    $terms_ids = $dokanrow->terms->pluck('term_id');
                ...
                <div class="additional_details mb30">
                    <div class="row">
                        <div class="col-lg-12 pl15-767 pr15-767">
                            <h3 class="mb30">{{ $translate_attribute->name }}</h3>
                        </div>
                        @php $terms = $attribute['child'] @endphp
                        @foreach($terms as $term )
                            @php $translate_term = $term->translateOrOrigin(app()->getLocale()); @endphp
                        <div class="col-md-6 col-lg-6 col-xl-4  pr0 pl15-767">
                            <div class="listing_feature_iconbox mb20">
