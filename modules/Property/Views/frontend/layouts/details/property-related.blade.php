            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="main-title text-center">
                        <h2>{{ __('Nearby Popular Business') }}</h2>
                        <p>{{ __('Discover some of the most popular listings in :location based on user reviews and ratings.', ['location' => $row->location ? $row->location->name : '']) }}
                        </p>
                    </div>
                </div>
                <div class="col-lg-12">
