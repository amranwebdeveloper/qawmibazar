    ...
    <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group @if (!is_default_lang()) d-none @endif ">
                    ...
                    <select name="seo_index" class="form-control">
                        <option value="1" @if (isset($meta_seo['seo_index']) and $meta_seo['seo_index'] == 1) selected @endif>{{ __('Yes') }}
                        </option>
                        <option value="0" @if (isset($meta_seo['seo_index']) and $meta_seo['seo_index'] == 0) selected @endif>{{ __('No') }}
                        </option>
                    </select>
                </div>
            </div>
        ...
        <div class="tab-content" data-condition="seo_index:is(1)">
            <div class="tab-pane active" id="seo_1">
                ...
                <div class="form-group">
                    <label class="control-label">{{ __('SEO Header Code') }}</label>
                    <textarea name="seo_header" rows="3" class="form-control"
                        placeholder="{{ $row->short_desc ?? __('Enter Header Code...') }}">{{ $meta_seo['seo_header'] ?? '' }}</textarea>
                </div>
                @if (is_default_lang())
