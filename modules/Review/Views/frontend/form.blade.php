                    ...
                    <div class="col-lg-5">
                        <div class="review-box-score">
                            <div class="review-score">
                                {{ $review_score['sbc_total'] }}<span class="per-total">/5</span>
                            </div>
                            <div class="review-score-text">
                                {{ $review_score['sbc_text'] }}
                            </div>
                                ...
                                @foreach ($listImages as $oneImages)
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <div class="review_upload_item" data-toggle="modal"
                                            data-target="#modal_dokan_{{ $item->id }}"
                                            style="background-image: url({{ @$imagesData['download'] }});">
                                        </div>
                                    </div>
                                @endforeach
                                <div class="modal" id="modal_dokan_{{ $item->id }}" tabindex="-1" role="dialog">
