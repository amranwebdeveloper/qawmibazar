        ...
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    ...
                    <div class="panel-body panel-index">
                        <form
                            action="{{ route('location.admin.store', ['id' => '-1', 'lang' => request()->query('lang')]) }}"
                            method="post">
                            @csrf
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    ...
                    <div class="col-left">
                        <form method="get" action="{{ route('location.admin.index') }}"
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="title">
                                                <a
                                                    href="{{ route('location.admin.edit', ['id' => $row->id]) }}">{{ $prefix . ' ' . $row->name }}</a>
                                            </td>
