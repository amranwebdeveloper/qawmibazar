<div class="home-listing-slider">
    @php
        ...
        if (empty($banner_images_str)) {
            $banner_images_str = $row->image_id;
        }
    @endphp
                        ...
                        <div class="banner-style-one owl-theme owl-carousel">
                            @foreach ($banner_images as $key => $val)
                                <div class="slide slide-one"
                                    style="background-image: url({{ \Modules\Media\Helpers\FileHelper::url($val, 'full') }});height: 400px;">
                                </div>
                            @endforeach
                        </div>
            ...
            <div class="col-lg-12">
                <div class="home_content listing slider_style">
                    <div class="home-text home6 text-center  ">
                        <h1 class="fz50 color-white">{{ $row->name }}</h1>
                        @if ($row->content)
                    ...
                    <div class="breadcrumb_content">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/location') }}">{{ __('Location') }}</a>
                            </li>
