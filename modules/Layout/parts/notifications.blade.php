@if (Auth::check())
    ...
    <li class="dropdown-notifications dropdown p-0">
        <a href="#" data-toggle="dropdown" class="is_login">
            <span class="position-relative"><i class="fa fa-bell mr-2"></i>
                <span class="badge badge-danger notification-icon">{{ $countUnread }}</span></span>
        </a>
        <ul class="dropdown-menu overflow-auto notify-items dropdown-container dropdown-menu-right dropdown-large pb-0">
            ...
            <div class="dropdown-footer text-center">
                <a class="text-white" href="{{ route('core.notification.loadNotify') }}">{{ __('View More') }}</a>
            </div>
        </ul>
    </li>
@endif
