...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard' }} - {{ setting_item('site_title') ?? 'Qawmi Bazar' }}</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 copy-right">
                            {{ date('Y') }} &copy; {{ __('Qawmi Bazar by') }} <a
                                href="{{ __('https://www.amranwebdeveloper.com') }}"
                                target="_blank">{{ __('Amran Web Developer') }}</a>
                        </div>
                        <div class="col-md-6">
                            <div class="text-md-right footer-links d-none d-sm-block">
                                <a href="{{ __('https://www.amranwebdeveloper.com') }}"
                                    target="_blank">{{ __('About Us') }}</a>
                                <a href="{{ __('https://amranwebdeveloper.com/contact') }}"
