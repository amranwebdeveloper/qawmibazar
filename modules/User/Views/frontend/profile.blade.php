    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="my_profile_setting_input form-group">
                                        ...
                                        <input type="text" name="user_name"
                                            value="{{ old('user_name', $dataUser->user_name) }}" class="form-control">
                                    </div>
                                    <div class="my_profile_setting_input form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="my_profile_setting_input form-group">
                                                ...
                                                <input type="text"
                                                    value="{{ old('first_name', $dataUser->first_name) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="my_profile_setting_input form-group">
                                        ...
                                        <input type="text" value="{{ old('address2', $dataUser->address2) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="my_profile_setting_input form-group">
                                                <label>{{ __('City') }}</label>
                                                <input type="text" value="{{ old('city', $dataUser->city) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="my_profile_setting_input form-group">
                                                ...
                                                <input type="text" value="{{ old('state', $dataUser->state) }}"
                                    ...
                                    <div class="my_profile_setting_input form-group">
                                        <label>{{ __('Job') }}</label>
                                        <input type="text" value="{{ old('job', $dataUser->job) }}" name="job"
                                            class="form-control">
                                    </div>
                                    <div class="my_profile_setting_input form-group">
                                    ...
                                    <div class="my_profile_setting_input form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="birthday" class="form-control date-picker">
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="my_profile_setting_input">
                                        <button class="btn update_btn style2"
                ...
                <div class="col-xl-4">
                    <div class="my_profile_setting_input become-agent">
                        @if (!Auth::user()->hasPermissionTo('dashboard_vendor_access') and setting_item('vendor_enable'))
                            <a class="btn update_btn style2"
                                href=" {{ route('user.upgrade_vendor') }}">{{ __('Become a Local Guide') }}</a>
                        @endif
                    </div>
