...
@section('content')
    <div class="container">
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                @if (!empty($rows))
                    <form method="post" action="{{ url('admin/module/page/bulkEdit') }}"
            ...
            <div class="col-left">
                <form method="get" action="{{ url('/admin/module/page/') }} "
                                ...
                                @foreach ($rows as $row)
                                    <tr>
                                        <td><input type="checkbox" name="ids[]" class="check-item"
                                                value="{{ $row->id }}"></td>
                                        <td class="title">
                                            <a href="{{ url('admin/module/page/edit/' . $row->id) }}"> {{ $row->title }}
                                            </a>
                                        </td>
                                        <td>
                                            {{ $row->slug }} </a>
                                        ...
                                        <td>
                                            <a href="{{ route('page.admin.edit', ['id' => $row->id]) }}"
